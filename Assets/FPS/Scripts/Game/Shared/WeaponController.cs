...
namespace Unity.FPS.Game
{
    ...
    public class WeaponController : MonoBehaviour
    {
        ...
        public void ConfigureForStartLoadout(int maxAmmo, float reloadDurationSeconds)
        {
            MaxAmmo = maxAmmo;
            ClipSize = Mathf.Max(1, maxAmmo);
            AmmoReloadDelay = 0f;
            AmmoReloadRate = maxAmmo / Mathf.Max(0.01f, reloadDurationSeconds);
            m_CurrentAmmo = MaxAmmo;
            m_CarriedPhysicalBullets = HasPhysicalBullets ? ClipSize : 0;
            CurrentAmmoRatio = 1f;
        }
