...
namespace Unity.FPS.AI
{
    ...
    public class EnemyController : MonoBehaviour
    {
        ...
        [Header("Combat Feel")]
        [Tooltip("How much spread to apply when the enemy fires at the player")]
        public float AimSpread = 0.015f;

        [Tooltip("Extra spread when the enemy is moving")]
        public float MovementSpreadMultiplier = 0.9f;
        ...
        void Start()
        {
            ...
            if (m_EnemyManager == null)
            {
                ...
                m_EnemyManager = managerObject.AddComponent<EnemyManager>();
            }
        ...
        public bool TryAtack(Vector3 enemyPosition)
        {
            ...
            Vector3 aimPosition = enemyPosition;
            float spread = AimSpread;

            if (NavMeshAgent && NavMeshAgent.velocity.magnitude > 0.1f)
            {
                spread *= MovementSpreadMultiplier;
            }

            aimPosition += Random.insideUnitSphere * spread;
            OrientWeaponsTowards(aimPosition);
